...
export function resetEmail(link: string): { html: string; text: string } {
  const text = `Reset your CiteRank password
...
change.`;
  ...
  <h1 style="font-size:20px;font-weight:800;letter-spacing:-.02em;margin:0 0 14px">Reset your CiteRank password</h1>
  ...
  <p style="margin:0 0 24px"><a href="${link}" style="display:inline-block;background:#2563eb;color:#fff;font-weight:700;font-size:15px;text-decoration:none;padding:12px 22px;border-radius:10px">Choose a new password</a></p>
